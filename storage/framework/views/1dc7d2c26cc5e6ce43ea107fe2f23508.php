...
<div id="gtw-root">
  ...
  <div class="gtw-topline">
    ...
    <span class="gtw-mono"><?php echo e(today()->format('d M Y')); ?></span>
  </div>
  ...
  <div class="row g-3 mb-3">
    <div class="col-6 col-md-3">
      <div class="gtw-stat" style="--accent:var(--gtw-cyan); --accent-dim:var(--gtw-cyan-dim)">
        <div class="d-flex justify-content-between align-items-start">
          <div>
            <div class="gtw-stat-value"><?php echo e($stats['total_countries']); ?></div>
    ...
    <div class="col-6 col-md-3">
      <div class="gtw-stat" style="--accent:var(--gtw-mint); --accent-dim:var(--gtw-mint-dim)">
        <div class="d-flex justify-content-between align-items-start">
          <div>
            <div class="gtw-stat-value"><?php echo e($stats['total_ports']); ?></div>
    ...
    <div class="col-6 col-md-3">
      <div class="gtw-stat" style="--accent:var(--gtw-coral); --accent-dim:var(--gtw-coral-dim)">
        <div class="d-flex justify-content-between align-items-start">
          <div>
            <div class="gtw-stat-value"><?php echo e($stats['high_risk_count']); ?></div>
    ...
    <div class="col-6 col-md-3">
      <div class="gtw-stat" style="--accent:var(--gtw-violet); --accent-dim:rgba(155,140,255,.14)">
        <div class="d-flex justify-content-between align-items-start">
          <div>
            <div class="gtw-stat-value"><?php echo e($stats['news_count']); ?></div>
    ...
    <div class="col-12 col-lg-8">
      <div class="gtw-card">
        <div class="gtw-card-header">
          ...
          <a href="<?php echo e(route('countries.index')); ?>" class="gtw-btn">Lihat Semua</a>
        </div>
          ...
          <div class="table-responsive">
            <table class="gtw-table">
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    <a href="<?php echo e(route('countries.show',$code)); ?>" class="gtw-country-link">
                      <?php if(($risk['risk_level'] ?? '') === 'high' || ($risk['risk_level'] ?? '') === 'critical'): ?>
                        <span class="gtw-pulse-dot"></span>
                      <?php endif; ?>
                      <span><?php echo e($risk['flag_emoji'] ?? ''); ?> <?php echo e($risk['country_name']); ?></span>
                    </a>
                  </td>
                  <td><span class="gtw-metric"><?php echo e(number_format($risk['weather_score'],1)); ?></span></td>
                  <td><span class="gtw-metric"><?php echo e(number_format($risk['inflation_score'],1)); ?></span></td>
                  <td><span class="gtw-metric"><?php echo e(number_format($risk['currency_score'],1)); ?></span></td>
                  <td><span class="gtw-metric"><?php echo e(number_format($risk['news_sentiment_score'],1)); ?></span></td>
                  <td>
                    <div class="gtw-score-wrap">
                      <span class="gtw-score-fig gtw-risk-<?php echo e($risk['risk_level']); ?>"><?php echo e(number_format($risk['total_score'],1)); ?></span>
                      <span class="gtw-score-meter"><span class="gtw-meter-<?php echo e($risk['risk_level']); ?>" style="width:<?php echo e(min(100, $risk['total_score'])); ?>%"></span></span>
                      <span class="gtw-score-label gtw-risk-<?php echo e($risk['risk_level']); ?>"><?php echo e($risk['risk_label']); ?></span>
                    </div>
                  </td>
                </tr>
    ...
    <div class="col-12 col-lg-4">
      ...
      <div class="gtw-card">
        <div class="gtw-card-header">
          ...
          <a href="<?php echo e(route('watchlist.index')); ?>" class="gtw-btn">Kelola</a>
        </div>
        <div class="gtw-card-body">
          ...
          <div class="gtw-watch-item">
            <span class="gtw-watch-name"><?php echo e($item->country->flag_emoji ?? ''); ?> <?php echo e($item->country_name); ?></span>
            <a href="<?php echo e(route('countries.show',$item->country_code)); ?>" class="gtw-btn">Detail</a>
          </div>
    ...
    <div class="col-12 col-lg-4">
      <div class="gtw-card">
        <div class="gtw-card-header">
          ...
          <a href="<?php echo e(route('news.index')); ?>" class="gtw-btn">Semua</a>
        </div>
        <div class="gtw-card-body">
          ...
          <div class="gtw-news-item" data-sentiment="<?php echo e($news->sentiment); ?>">
            <div class="d-flex justify-content-between align-items-center">
              <span class="gtw-news-badge" style="background:var(--gtw-<?php echo e($news->sentiment === 'positive' ? 'mint' : ($news->sentiment === 'negative' ? 'coral' : 'muted')); ?>-dim, rgba(148,178,208,.14)); color:<?php echo e($news->sentiment === 'positive' ? 'var(--gtw-mint)' : ($news->sentiment === 'negative' ? 'var(--gtw-coral)' : 'var(--gtw-muted)')); ?>"><?php echo e(ucfirst($news->sentiment)); ?></span>
              <span class="gtw-news-time"><?php echo e($news->time_ago); ?></span>
            </div>
            <a href="<?php echo e($news->url); ?>" target="_blank" class="gtw-news-title"><?php echo e(Str::limit($news->title, 80)); ?></a>
          </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\Global Supply\supply-chain-platform\resources\views/dashboard/index.blade.php ENDPATH**/ ?>