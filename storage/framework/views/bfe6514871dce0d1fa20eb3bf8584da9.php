  ...
  <div class="pld-controls">
    ...
    <select id="cfilter" class="form-select">
      ...
      <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($c->code); ?>" <?php echo e(request('country')===$c->code?'selected':''); ?>><?php echo e($c->flag_emoji); ?> <?php echo e($c->name); ?></option>
    ...
    <div class="col-lg-5">
      <div class="pld-panel">
        <div class="pld-panel-head">
          ...
          <span class="pld-count" id="pcnt"><?php echo e($ports->count()); ?></span>
        </div>
        <div class="pld-list" id="pldList">
          ...
          <div class="port-item"
            ...
            onclick="focusPort(<?php echo e($p->latitude ?? 0); ?>,<?php echo e($p->longitude ?? 0); ?>,'<?php echo e(addslashes($p->port_name)); ?>')">
            <div>
              <div class="port-name"><?php echo e($p->port_name); ?></div>
              <div class="port-sub"><?php echo e($p->country_name); ?> · <span class="port-code"><?php echo e($p->port_code); ?></span></div>
            </div>
            <span class="pld-flag <?php echo e($p->congestion_level); ?>"><?php echo e(ucfirst($p->congestion_level)); ?></span>
          </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\Global Supply\supply-chain-platform\resources\views/ports/index.blade.php ENDPATH**/ ?>